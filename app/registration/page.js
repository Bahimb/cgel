...
export default function Page() {
  return (
    ...
    <div className="page-hero-inner">
      ...
      <h1>S'inscrire aux CGEL Days 2026</h1>
    ...
    <div className="container">
      <div className="reg-grid">
        <div className="reg-form-box">
          ...
          <div className="reg-note">En vous inscrivant, vous confirmez votre demande pour les <strong>CGEL Days — 3<sup>e</sup> Édition · 01 oct. 2026</strong>. Le comité d'organisation examinera votre demande.</div>
