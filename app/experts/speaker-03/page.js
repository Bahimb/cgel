export const metadata = {
  title: "Nom de l'intervenant — Spécialiste en Endoscopie digestive | Experts CGEL",
  description: "Endoscopie digestive · Établissement à annoncer · Algérie — CGEL Scientific Days 3e Édition.",
  openGraph: {
    title: "Nom de l'intervenant — Spécialiste en Endoscopie digestive | Experts CGEL",
    description: "Endoscopie digestive · Établissement à annoncer · Algérie — CGEL Scientific Days 3e Édition.",
    type: "website",
    ...
    <div className="container">
      <div className="expert-detail-grid">
        <div className="expert-detail-card">
          <div className="img"><img src="https://images.unsplash.com/photo-1537368910025-70035079f3d5?q=80&w=800&auto=format&fit=crop" alt="Nom de l'intervenant — Spécialiste en Endoscopie digestive" /></div>
          <div className="body">
            <h1>Nom de l'intervenant</h1>
            <p className="role">Spécialiste en Endoscopie digestive</p>
            <p className="inst">Établissement à annoncer · Algérie</p>
            <div className="boxes">
