    ...
    <div className="bg-[#F8FAFC] min-h-screen">
      <div className="bg-white border-b border-[#E2E8F0]">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
          ...
          <h1 className="mt-4 font-serif text-[30px] lg:text-[36px] leading-[1.05] tracking-[-0.02em] text-[#0F1D3A]">Contacter le CGEL</h1>
          <p className="mt-3 text-[14px] leading-6 text-[#475569]">Écrivez au comité d'organisation du collège.</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
        <div className="grid lg:grid-cols-[1.05fr_0.9fr] gap-6 lg:gap-8 items-start">
          <div className="border border-[#E2E8F0] bg-white">
            ...
            <div className="p-6 space-y-0 divide-y divide-[#E2E8F0] border-b border-[#E2E8F0]">
              <a href={`tel:${eventData.contact.phone.replace(/\s/g, "")}`} className="flex gap-4 py-4 hover:bg-[#F8FAFC] -mx-6 px-6 transition-colors">
                ...
                <div>
                  <p className="text-[10px] tracking-[0.12em] uppercase font-semibold text-[#64748B]">Téléphone</p>
              ...
              <a href={`mailto:${eventData.contact.email}`} className="flex gap-4 py-4 hover:bg-[#F8FAFC] -mx-6 px-6 transition-colors">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] tracking-[0.12em] uppercase font-semibold text-[#64748B]">E-mail</p>
              ...
              <a href={eventData.contact.websiteHref} target="_blank" rel="noreferrer" className="flex gap-4 py-4 hover:bg-[#F8FAFC] -mx-6 px-6 transition-colors">
                ...
                <div>
                  <p className="text-[10px] tracking-[0.12em] uppercase font-semibold text-[#64748B]">Site web</p>
                  <p className="text-[13px] font-semibold text-[#0F1D3A]">{eventData.contact.website}</p>
                </div>
              </a>
            </div>

            <div className="px-6 py-4 bg-[#0F1D3A] text-white flex gap-4 items-center">
              <div className="shrink-0 w-12 h-12 bg-white flex items-center justify-center p-1.5">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/logo/uc2.png" alt="Partenariat universitaire — partenaire scientifique du CGEL" className="max-h-full max-w-full object-contain" />
              </div>
              <div>
                <p className="text-[11px] tracking-[0.08em] uppercase font-semibold text-white/60">Partenaire scientifique</p>
                <p className="text-[13px] font-semibold">Partenariat universitaire</p>
                <p className="mt-1 text-[11px] text-white/40">Les informations partenaire seront enrichies dès réception.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="border border-[#E2E8F0] bg-white">
              <div className="px-6 py-4 border-b border-[#E2E8F0] bg-[#F8FAFC]">
                <h3 className="text-[11px] tracking-[0.12em] uppercase font-semibold text-[#023DA5]">Détails de l'événement</h3>
              </div>
              ...
              <div className="p-4 border-t border-[#E2E8F0]">
                <Link href="/venue" className="inline-flex w-full items-center justify-center border border-[#E2E8F0] bg-white px-4 py-2.5 text-[11px] tracking-[0.06em] uppercase font-semibold text-[#023DA5] hover:bg-[#F8FAFC] focus-visible:ring-2 focus-visible:ring-[#023DA5]">
                  Voir le lieu
                </Link>
              </div>
            </div>
