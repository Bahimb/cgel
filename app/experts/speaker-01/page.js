    ...
    <div className="container">
      <div className="expert-detail-grid">
        <div className="expert-detail-card">
          <div className="img"><img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?q=80&w=800&auto=format&fit=crop" alt="Nom de l'intervenant — Spécialiste en Gastroentérologie" /></div>
          <div className="body">
            <h1>Nom de l'intervenant</h1>
            <p className="role">Spécialiste en Gastroentérologie</p>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:"1rem"}}>
          <div className="expert-bio">
            ...
            <p className="bio">Biographie à annoncer — profil détaillé à publier dès que le programme sera finalisé.</p>
