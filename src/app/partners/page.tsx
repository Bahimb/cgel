...
export const metadata: Metadata = {
  title: "Partners — GCEL 3rd Edition Scientific Days",
  description: "Sponsors & Partners of GCEL 3rd Edition Scientific Days — all partners presented equally.",
};
    ...
    <div className="bg-[#F8FAFC] min-h-screen">
      <div className="bg-white border-b border-[#E2E8F0]">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
          ...
          <h1 className="mt-4 font-serif text-[30px] lg:text-[36px] leading-[1.05] tracking-[-0.02em] text-[#0F1D3A]">Our Sponsors & Partners</h1>
          <p className="mt-3 text-[14px] leading-6 text-[#475569] max-w-[640px]">All partners are presented equally — no tiers. A calm, institutional logo wall.</p>
          <p className="mt-2 text-[11px] text-[#94A3B8] border-l-2 border-[#E2E8F0] pl-3">Partner announcements coming soon — placeholders are easily replaceable.</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
          ...
          {partners.map((p) => (
            <Link key={p.slug} href={`/partners/${p.slug}`} className="bg-white px-4 py-10 flex flex-col items-center justify-center text-center hover:bg-[#F8FAFC] transition-colors group">
              <div className="w-10 h-10 border border-[#E2E8F0] flex items-center justify-center text-[#94A3B8] group-hover:border-[#023DA5] group-hover:text-[#023DA5] transition-colors">
                <span className="text-[10px] font-bold tracking-[0.08em]">GCEL</span>
              </div>
        ...
        <div className="mt-8 border border-[#E2E8F0] bg-white px-5 py-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h3 className="text-[12px] font-bold text-[#0F1D3A]">Become a partner</h3>
            <p className="text-[12px] text-[#64748B] mt-1">Contact college.hgel@gmail.com · 0540 69 95 13 for partnership opportunities.</p>
          </div>
