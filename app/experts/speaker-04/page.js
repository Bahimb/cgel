export const metadata = {
  title: "Nom de l'intervenant — Intelligence artificielle en médecine | Experts CGEL",
  description: "IA & Santé numérique · Établissement à annoncer · International — CGEL Scientific Days 3e Édition.",
  openGraph: {
    title: "Nom de l'intervenant — Intelligence artificielle en médecine | Experts CGEL",
    description: "IA & Santé numérique · Établissement à annoncer · International — CGEL Scientific Days 3e Édition.",
    type: "website",
    ...
    <div className="container">
      <div className="expert-detail-grid">
        <div className="expert-detail-card">
          <div className="img"><img src="https://images.unsplash.com/photo-1594824476967-48c8b964273f?q=80&w=800&auto=format&fit=crop" alt="Nom de l'intervenant — Intelligence artificielle en médecine" /></div>
          <div className="body">
            <h1>Nom de l'intervenant</h1>
            <p className="role">Intelligence artificielle en médecine</p>
